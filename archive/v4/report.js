            ...
            if (section.enableSectionPreview && section.sectionPreviewKey) {
                ...
                const $sectionPreview = $(`<div class="section-preview">
                    ...
                    <div class="preview-button-container">
                        <button type="button" id="${previewKey}-reset" class="reset-preview-button secondary" title="Reset to auto-update">Reset</button>
                    </div>
                </div>`);
                ...
                $(`#${previewKey}-preview`).on("input change blur", function() {
                    ...
                    // Change button appearance to indicate manual edit mode
                    $(`#${previewKey}-reset`).removeClass('secondary').addClass('primary');
                });
                
                // Reset button to re-enable auto-updating
                $(`#${previewKey}-reset`).on("click", function() {
                    sectionPreviewManuallyEdited[previewKey] = false;
                    updateSectionPreview(previewKey);
                    // Change button back to secondary style
