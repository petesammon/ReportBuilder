    ...
    },
    {
        ...
        params: {
            paramsRestingEcho: {
                ...
                options: [
                    { label: "Normal LV", title: "Normal left ventricular size, wall thickness and systolic function (EF >55%).", default: true,},
...
Normal aorta dimensions.`},
            ...
            paramsStressEcho: {
                ...
                options: [
                    { label: "Appropriate augmentation", title: "Echo images were acquired at peak stress which demonstrated appropriate augmentation of all left ventricular segments with slight decrease in cavity size (normal response).", default: true,},
                    { label: "Appropriate augmentation, cavity decrease", title: "Echo images were acquired at peak stress which demonstrated appropriate augmentation of all left ventricular segments with slight decrease in cavity size (normal response)."},
                    { label: "New RWMAS", title: "Echo images were acquired at peak stress which demonstrated new regional wall motion abnormalities."},
                    { label: "New global LVSD", title: "Echo images were acquired at peak stress which demonstrated global left ventricular systolic dysfunction."},
                    { label: "Baseline abnormalities persist.", title: "Baseline abnormalities persist."},
                ],
                textareaSize: 3,
            },
        },
