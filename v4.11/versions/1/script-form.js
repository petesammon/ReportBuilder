...
jQuery(document).ready(function () {
    ...
    function createSummaryModal(section) {
        ...
        Object.entries(section.params).forEach(([paramKey, paramOption]) => {
            ...
            // Build summary checkbox - use virtual state if available, otherwise use summaryDefault
            // This ensures that when modals are lazy-loaded, they initialize with correct state
            let defaultChecked = '';
            if (window.summaryCheckboxStates && window.summaryCheckboxStates[paramKey] !== undefined) {
                // Use virtual state (from initializeDefaultState or previous user interaction)
