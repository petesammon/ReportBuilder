...
BP: {{BP}}`},
    ...
    pRWMA: {
        title: "RWMAs",
        options: "customtext", 
        summarytext: "Regional wall motion abnormalities described above.",
        enableSummary: true,
    ...
    pLVH: {
        ...
        options: [
            ...
            { label: "Basal septal bulge, normal wall thickness", title: "Basal septal bulge with otherwise normal wall thickness.", summarytext: "basal septal bulge, normal wall thickness,"},
        ],
        enableSummary: true,
        summaryDefault: true,
        summaryOrder: 3.1,
    ...
    pLVG: {
        title: "LV Geometry",
        options: [
            { label: "Normal LV geometry", title: "(Normal LV geometry by RWT/LV Mass assessment).", default: true },
            { label: "Concentric Remodelling", title: "(Concentric remodelling by RWT/LV Mass assessment)." },
            { label: "Concentric Hypertrophy", title: "(Concentric hypertrophy by RWT/LV Mass assessment)." },
            { label: "Eccentric Hypertrophy", title: "(Eccentric hypertrophy by RWT/LV Mass assessment)." },
        ],
        enableSummary: true,
        summaryDefault: false,
        summaryOrder: 3.2,
    ...
    pDiastology: {
        ...
        options: [
            ...
            { label: "Impaired diastolic function, indeterminate filling pressures.", title: "Impaired diastolic function, indeterminate filling pressures." },
            { label: "Impaired diastolic function, elevated filling pressures.", title: "Impaired diastolic function, elevated filling pressures." },
    ...
    pLVMeasurements: {
        ...
        options: [
            { label: "Sinus Rhythm", title: `IVS = {{IVSd}}, PWd = {{LVPWd}}, LVIDd = {{LVIDd}}, LVIDs = {{LVIDs}}
LV Mass = {{LVMASS}} (Indexed = {{LVMASSInd}}), RWT = {{RWT}}
...
Septal S prime = {{SPrimeSept}}, Lateral S prime = {{SPrimeLat}}`, default: true },
            { label: "SR + Volumes", title: `IVS = {{IVSd}}, PWd = {{LVPWd}}, LVIDd = {{LVIDd}}, LVIDs = {{LVIDs}}
...
Septal S prime = {{SPrimeSept}}, Lateral S prime = {{SPrimeLat}}`},
            { label: "AF + Volumes", title: `IVS = {{IVSd}}, PWd = {{LVPWd}}, LVIDd = {{LVIDd}}, LVIDs = {{LVIDs}}
LVEDV = {{LVEDV}} (Indexed = {{LVEDVInd}}), LVESV = {{LVESV}} (Indexed = {{LVESVInd}})
Peak E velocity = {{EVel}}, E DecT = {{EDecT}}
Septal E prime = {{EPrimeSept}}, Lateral E prime = {{EPrimeLat}}, E/E prime (septal) = {{EEPrimeSept}}
Septal S prime = {{SPrimeSept}}, Lateral S prime = {{SPrimeLat}}`},
...
Septal S prime = {{SPrimeSept}}, Lateral S prime = {{SPrimeLat}}`},
    ...
    pLVEF: {
        title: "EF - Report Body",
        options: [
            { label: "Auto EF + GLS", title: `Auto EF = {{EFAuto}}
Global Averaged Longitudinal Strain = {{GLS}}`, default: true,},
            { label: "Biplane + Auto EF + GLS", title: `Simpsons Biplane LVEF = {{EFBP}}, Auto EF = {{EFAuto}}
Global Averaged Longitudinal Strain = {{GLS}}`},
            { label: "Biplane + Visual EF", title: `Simpsons Biplane LVEF = {{EFBP}}, Visual EF = {{EFVisual}}`},
            { label: "Visual EF only", title: `Visual EF = {{EFVisual}}`},
            { label: "Oncology Template", title: `Simpsons Biplane LVEF = {{EFBP}}
Auto EF = {{EFAuto}}
3D EF = %
Global Averaged Longitudinal Strain = {{GLS}}`},
        ],
    ...
    pMVMeasurements: {
        ...
        options: [
            ...
            { label: "Regurgiation", title: `MR Jet: VC width = {{MRVCD}}, PISAr (Als Vel. of {{MRALSVEL}}) = {{MRPISA}}, VTI = {{MRVTI}}, RV = {{MRRV}}, ERO = {{MRERO}}`},
            { label: "Inflow and Regurgitation", title: `MV Inflow: Vmax = {{MVVmax}}, MeanPG = {{MVMeanPG}}, VTI = {{MVVTI}}
MR Jet: VC width = {{MRVCD}}, PISAr (Als Vel. of {{MRALSVEL}}) = {{MRPISA}}, VTI = {{MRVTI}}, RV = {{MRRV}}, ERO = {{MRERO}}`},
    ...
    pAS: {
        ...
        options: [
            ...
            { label: "LF/LG AS (mod/sev)", title: `Low stroke volume.
Low-flow/low-gradient aortic stenosis - unable to differentiate between moderate and severe grades without further investigation.`, summarytext: "Low-flow/low-gradient aortic stenosis (see notes above)"},
            { label: "No obstruction", title: "No obstruction." },
...
TAPSE = {{TAPSE}}, S prime = {{RVS}}, FAC = {{FAC}}`},
    ...
    pRVtoRA: {
        title: "TR Vmax",
        options: [
            { label: "Insufficient for measurement", title: "TR Vmax = insufficient for measurement", default: true,},
...
TV inflow: Vmax = {{EffTVVmax}}, Vmin = {{EffTVVmin}}; Variation = {{EffTVVar}} (normal range <40%)`, default: true },
    ...
    spLV: {
        title: "EF - Summary",
        options: [
            { label: "Auto EF", title: "Estimated ejection fraction {{EFAuto}}", default: true },
            { label: "Biplane EF", title: "Estimated ejection fraction {{EFBP}}"},
            { label: "Visual EF", title: "Estimated ejection fraction {{EFVisual}}"},
