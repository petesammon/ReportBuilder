...
BP: {{BP}}`},
    ...
    pLVH: {
        title: "LV Geometry",
        options: [
            { label: "Normal LV geometry", title: "Normal LV geometry.", summarytext: "normal geometry,", default: true },
            { label: "Concentric Remodelling", title: "Concentric remodelling.", summarytext: "concentric remodelling,"},
            { label: "Concentric Hypertrophy", title: "Concentric hypertrophy.", summarytext: "concentric hypertrophy,"},
            { label: "Eccentric Hypertrophy", title: "Eccentric hypertrophy.", summarytext: "eccentric hypertrophy,"},
        ],
        enableSummary: true,
        summaryDefault: true,
        summaryOrder: 3,
