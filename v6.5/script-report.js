...
/* EchoTools v6.27 - Central Registry with Span-based ContentEditable + Algorithms */
...
jQuery(document).ready(function () {
    ...
    function initializeRegistry() {
        ...
        console.log('[v6.27 Registry] Initialized with', Object.keys(registry).length, 'entries');
     ...
     */
    function setParameterByLabel(paramHandle, label) {
        ...
        if (paramConfig.options === 'customtext') {
            setParamValue(paramHandle, label, 'clean', false);
        ...
        if (!matchingOpt) {
            ...
            setParamValue(paramHandle, label, 'dirty', false);
            updateSpansForHandle(paramHandle);
        ...
        setParamValue(paramHandle, title, 'clean', false);
