window.options = [
    ...
    },
    {
        ...
        params: {
            RWMAs: {
                title: "RWMAs",
                options: "customtext", summarytext: "Regional wall motion abnormalites described above.",
                enableSummary: true,
        ...
        params: {
            MV: {
                ...
                options: [
                    ...
                    { label: "BioMVR", title: "BioMVR in situ, stable." },
                    { label: "Mechanical MVR", title: "Mechanical MVR in situ, stable." },
                    { label: "Mitral TEER", title: "Mitral TEER device(s) in situ, stable." },
                ],
                enableSummary: true,
                summaryDefault: false,
                summaryOnChange: true,
